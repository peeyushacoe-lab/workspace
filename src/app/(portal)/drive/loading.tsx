export default function DriveLoading() {
  return (
    <div className="flex h-full bg-[#0f1321] animate-pulse">
      <aside className="w-56 flex-shrink-0 border-r border-[rgba(0,255,255,0.08)] bg-[#0a0d1c] p-3 flex flex-col gap-1.5">
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-14 border-b border-[rgba(0,255,255,0.08)] flex items-center px-4 gap-3">
