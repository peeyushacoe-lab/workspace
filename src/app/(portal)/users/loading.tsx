  ...
  return (
    <div className="p-8 animate-pulse space-y-6">
      ...
      <div className="bg-[#1b1f2e] rounded-xl border border-[rgba(0,255,255,0.08)] overflow-hidden">
        <div className="px-6 py-4 border-b border-[rgba(0,255,255,0.08)] flex gap-4">
          {["Name","Work Email","Role","Status","Joined"].map((h) => (
            <div key={h} className="h-4 w-24 bg-[#262939] rounded" />
          ))}
        </div>
        {[...Array(5)].map((_, i) => (
          <div key={i} className="px-6 py-4 flex items-center gap-4 border-b border-[rgba(0,255,255,0.06)]">
