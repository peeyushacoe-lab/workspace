  ...
  return (
    <div className="bg-[#1b1f2e] border border-[rgba(0,255,255,0.08)] rounded-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        <Icon className="w-4 h-4 text-[#5c6b72] flex-shrink-0" />
    ...
    <div className="min-h-screen bg-[#0f1321] text-[#dfe1f6]">
      ...
      <div className="px-6 pb-10 max-w-5xl space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-[#5c6b72]">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading && !data ? (
                  <tr>
                    <td colSpan={4} className="text-center text-[#5c6b72] py-10">
                  ...
                  data?.scheduledJobs.map((job) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-xs text-[#5c6b72] hidden md:table-cell">
          ...
          <div className="bg-[#1b1f2e] border border-[rgba(0,255,255,0.08)] rounded-xl overflow-hidden">
            ...
            {data.recentErrors.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 gap-2">
                ...
                <p className="text-[#5c6b72] text-sm">No recent errors</p>
              </div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {data.recentErrors.map((err, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right text-xs text-[#5c6b72] hidden sm:table-cell">
        ...
        {/* ── Quick links ── */}
        <div className="bg-[#1b1f2e] border border-[rgba(0,255,255,0.08)] rounded-xl p-4">
          <p className="text-[10px] text-[#5c6b72] uppercase tracking-widest mb-3">
            Related admin pages
          </p>
          <div className="flex flex-wrap gap-3">
            <Link
              href="/admin/queues"
              className="flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-lg bg-[#262939] text-[#bbc9cf] border border-[rgba(0,255,255,0.08)] hover:bg-[#2e3347] hover:text-[#dfe1f6] transition-colors"
            >
              <Zap className="w-3.5 h-3.5 text-[#00d2ff]" />
              Queue Monitor
              <ExternalLink className="w-3 h-3 text-[#5c6b72]" />
            </Link>
            <Link
              href="/admin/health"
              className="flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-lg bg-[#262939] text-[#bbc9cf] border border-[rgba(0,255,255,0.08)] hover:bg-[#2e3347] hover:text-[#dfe1f6] transition-colors"
