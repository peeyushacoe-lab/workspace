      ...
      <div className="grid xl:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-12 bg-[#12151D] rounded-xl border border-[#262A35]" />
            ))}
          </div>
          <div className="h-64 bg-[#12151D] rounded-xl border border-[#262A35]" />
          <div className="h-10 w-36 bg-[#12151D] rounded-lg" />
        </div>
        <div className="h-96 bg-[#12151D] rounded-xl border border-[#262A35]" />
      </div>
    </div>
  );
}
