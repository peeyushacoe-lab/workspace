      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#e8f0fe] flex items-center justify-center mb-4">
            <FileSpreadsheet className="w-8 h-8 text-[#1a56db]" />
          </div>
          <h2 className="text-base font-semibold text-[#202124] mb-1">No spreadsheets yet</h2>
          <p className="text-sm text-[#5f6368] mb-4">Create your first spreadsheet to get started</p>
            ...
            <div key={sheet.id}
              ...
              <div className="flex items-start justify-between gap-1">
                <div className="min-w-0">
                  <p className="text-sm font-medium text-[#202124] truncate">{sheet.title}</p>
