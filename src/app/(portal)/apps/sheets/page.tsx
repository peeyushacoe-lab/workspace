    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Spreadsheets</h1>
            <p className="text-sm text-muted mt-0.5">Create and collaborate on spreadsheets</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-base font-semibold text-foreground mb-1">No spreadsheets yet</h2>
          <p className="text-sm text-muted mb-4">Create your first spreadsheet to get started</p>
