    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-[#E6E9F0]">Presentations</h1>
            <p className="text-sm text-[#8A92A6] mt-0.5">Create and collaborate on presentations</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#0E2532] flex items-center justify-center mb-4">
            <Presentation className="w-8 h-8 text-[#00C2FF]" />
          </div>
          <h2 className="text-base font-semibold text-[#E6E9F0] mb-1">No presentations yet</h2>
          <p className="text-sm text-[#8A92A6] mb-4">Create your first presentation to get started</p>
            ...
            <div key={pres.id}
              ...
              <div className="flex items-start justify-between gap-1">
                <div className="min-w-0">
                  <p className="text-sm font-medium text-[#E6E9F0] truncate">{pres.title}</p>
